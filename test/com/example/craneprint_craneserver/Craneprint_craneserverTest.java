package com.example.craneprint_craneserver;
 ...
 */
public class Craneprint_craneserverTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/CranePrint CraneServer");
    }
